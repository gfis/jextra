...
/** An item of the generated LR(1) parser's {@link StateTable}, consisting of:
 *  <ul>
 *  <li>the marked symbol (in the right side of a production)</li>
 *  <li>the position of that symbol in the right side of a production</li>
 *  <li>the action: shift, reduce, accept (error is generated by Parser.delta)</li>
 *  <li>the successor for shift, or the production just recognized for reduce</li>
 *  </ul>
...
public class Item implements Comparable {
    ...
    private static String [] parserActions = new String[] { "" // keep in parallel with codes above
                         , "SHIFT"
                         , "REDUCE"
                         , "ACCEPT"
                         , "ERROR"
