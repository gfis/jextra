 ...
 *  <ul>
 *  <li>an array of objects to be processed recursively</li>
 *  <li>a map remembering the set of elements already queued
 *  (whether already processed or not)</li>
 *  <li>a pointer to the first object not yet processed</li>
 *  <li>a description of the queue for debugging purposes</li>
 *  </ul>
...
public abstract class Queue {
    ...
    /** Get the pointer to the first element not yet processed
...
*/
    /** Get an iterator for ALL elements of the queue
    ...
    /** Append an element to the queue without checking whether the
