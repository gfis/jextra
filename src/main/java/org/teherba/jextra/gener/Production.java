...
public class Production implements Comparable {
    ...
    public String legible() {
        ...
        while (iter.hasNext()) {
            Symbol member = (Symbol) iter.next();
            if (member != EOP) {
    ...
    public String toString() {
        ...
        while (iter.hasNext()) {
            result += Parm.getIndent() + ((Symbol)    iter.next()).toString() + Parm.getNewline();
        } // while hasNext
        iter = semantics.iterator();
        while (iter.hasNext()) {
            result += Parm.getIndent() + ((SemAction) iter.next()).toString() + Parm.getNewline();
        } // while hasNext
        Parm.decrIndent();
